...
// weighted sum of red, green, blue due to the 
// sensibility of our eyes.
...
const float SUBPIXEL_QUALITY = 0.2;
const float EDGE_THRESHOLD_MAX = 0.12;
...
void main()
{
	vec2 inverseScreenSize = 1.0 / vec2(textureSize(screenTexture, 0));
	vec3 hdrColor = texture(screenTexture, TexCoords).rgb;
   
	// Luma at the current fragment
	float lumaCenter = rgb2luma(hdrColor);
