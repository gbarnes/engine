...
namespace Dawn
{
	...
	void GfxRootSignature::SetRootSignatureDesc(
	...
	uint32_t GfxRootSignature::GetDescriptorTableBitMask(D3D12_DESCRIPTOR_HEAP_TYPE descriptorHeapType) const
	{
	...
	uint32_t GfxRootSignature::GetNumDescriptors(uint32_t rootIndex) const
	{
		assert(rootIndex < 32);
