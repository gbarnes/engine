...
namespace Dawn
{
	GfxGenerateMipsPSO::GfxGenerateMipsPSO()
	{
		...
		m_DefaultUAV = GfxBackend::AllocateDescriptors(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 4);
		UINT descriptorHandleIncrementSize = GfxBackend::GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
